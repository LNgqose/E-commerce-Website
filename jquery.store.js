(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.bankBusinessEmail = "yourbusiness@email.com"; // Your Business PayPal's account email address
			this.bankURL = "https://www.bank.fnb.com/cgi-bin/webscr"; // The URL of the PayPal's form
